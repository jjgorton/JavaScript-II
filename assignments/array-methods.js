...
//Array of people who donated more than $100 so they can be sent a gift.

const thankYouGift = runners.filter(function (person) {
...
//Create an array of companies to advertise the sponsors.

const companyList = runners.map(function (currentValue) {
...
//create list of emails for mailing list.

const mailingList = runners.map(personInfo => personInfo.email);

console.log(mailingList);

// //Filter out the duplicate companies with forEach.

// newCompList = [];
// companyList.forEach(function (currentValue) {
//     if (currentValue !== companyList.forEach(function (nextValue) {
//             return nextValue
//         })) {
//         newCompList.push(currentValue);
//     };
// });

// console.log(newCompList);